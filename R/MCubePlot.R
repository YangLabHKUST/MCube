...
mcubePlotExpr <- function(
    ...
    spot_size = 1, palettes = pals::brewer.bugn(20)[6:20],
...
#' Plot the spatial distribution of cell type proportions for 3D model
#'
...
#' Plot the spatial distribution of gene expression variations within a certain cell type
#'
#' @import ggplot2
...
#' Plot the spatial distribution of gene expression variations within a certain cell type in binary mode
#'
#' @import ggplot2
#'
#' @param object An \code{\link[=mcube-class]{mcube}} object with fitted results of the null model.
...
#' Plot the spatial distribution of gene expression variations within a certain cell type for 3D model
#'
